...
impl Command for ToggleBookmarkCommand {
    fn execute(
        &mut self,
        project: &mut Project,
        ...
        scene.bookmarks = toggle_bookmark_in_array(&scene.bookmarks, self.frame_time);
        Ok(None)
    }
